...
parser.add_argument('--A_nc', dest='A_nc', type=int, default=3, help='# of inputA image channels')
parser.add_argument('--B_nc', dest='B_nc', type=int, default=3, help='# of inputB image channels')
